...
const VerificationStep: React.FC = () => {
  ...
  const handleFileUpload = (
    ...
    if (fieldName === "cv") {
      setValue("cv", fileArray[0], { shouldValidate: true });
    } else if (fieldName === "certificates" || fieldName === "workPhotos") {
      const currentFiles = watch(fieldName) as File[];
      setValue(fieldName, [...currentFiles, ...fileArray], {
        shouldValidate: true,
  ...
  const renderBasicVerification = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        {errors.workPhotos && (
          <p className="text-sm text-red-600 mt-1">
            {errors.workPhotos.message as string}
          </p>
        )}
      </div>
    </div>
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 ${
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Help us verify your credentials and experience
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Upload CV, work photos, and optional certificates
                  </p>
                </div>
                {verificationType === "basic" && (
          ...
          <label className="relative cursor-pointer">
            ...
            >
              <div className="flex items-center">
                <Link className="w-6 h-6 text-purple-600 mr-3" />
                <div>
                  <h3 className="font-medium text-gray-900">Proof of Work</h3>
                  <p className="text-sm text-gray-500">
                    Share portfolio and project links
                  </p>
                </div>
                {verificationType === "proof" && (
                  <CheckCircle className="w-5 h-5 text-purple-600 ml-auto" />
        ...
        {errors.verificationType && (
          <p className="text-sm text-red-600">
            {errors.verificationType.message as string}
          </p>
        )}
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-700">
                Our team will review your submitted information within 24-48
                hours. You'll receive a notification via WhatsApp once your
